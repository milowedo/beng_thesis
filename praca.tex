...
\acknowledgements{Serdecznie podziękowania dla mojego promotora bez którego praca ta nie miałaby szansy powstać.}
...
\include{R1_wprowadzenie}
\include{R3_projekt}
\include{R4_implementacja}
\include{R5_interfejs}
\include{R6_podsumowanie}
