...
Architektura aplikacji jest złożona z części mobilnej oraz czterech serwisów, z czego każdy występuje
jako autonomiczna aplikacja z którą porozumiewanie odbywa się za pomocą protokołu HTTP. 
Warstwa prezentacyjna porozumiewając się z pozostałymi serwisami zapewnia użytkownikowi swobodne przeglądanie
wyników
W ten sposób każda składowa część aplikacji może być niezależnie zarządzana 

HTTP, czyli \texttt{Hypertext Transfer Protocol}
